...
<head>
    ...
    <style>
        @page {
            /* กำหนดขนาด 9x11 นิ้ว สำหรับกระดาษต่อเนื่อง */
            size: 9in 11in;
            margin: 0.5in; 
        }
        ...
        body {
            font-family: 'THSarabunNew';
            font-size: 16pt;
            /* ปรับเป็น 1.2 เพื่อให้สระไทยไม่ทับกันตอนพิมพ์ด้วยหัวเข็ม */
            line-height: 1.1;
            color: #000;
            margin: 0;
            padding: 0;
        ...
        /* ลบสีพื้นหลังออกเพื่อให้เครื่องหัวเข็มพิมพ์ได้คมชัด */
        .table thead th {
        ...
        .page-break {
            ...
            /* บังคับให้จบบล็อกในหน้านั้นๆ ไม่ให้มีเศษล้น */
            overflow: hidden;
        }

        /* ป้องกันไม่ให้บรรทัดสุดท้ายของตารางโดนตัดแบ่งหน้า */
...
<body>
    {{-- วนลูปบิลทั้งหมดที่ส่งมาจาก Controller --}}
    @foreach($invoices as $invoice)
        {{-- ถ้าไม่ใช่บิลใบสุดท้าย ให้ใส่คลาส page-break เพื่อขึ้นหน้าใหม่ --}}
